...
#SBATCH -t 24:00:00
#SBATCH -p single
#SBATCH -e ./error_out/_wASTRAL-gblock_%j.err
#SBATCH -o ./log_out/_wASTRAL-gblock_%j.log
...
output=("$working_directory"/aster/wastral_iqtree_gblock.stree)
