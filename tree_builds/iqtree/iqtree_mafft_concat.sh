...
#SBATCH -t 24:00:00
#SBATCH -p single
#SBATCH -e ./error_out/_IQTREE-concat-mafft_%j.err
#SBATCH -o ./log_out/_IQTREE-concat-mafft_%j.log
...
iqtree -s ~/genome_skimming/concat/Concat_mafft_90perc_nexus/Concat_mafft_90perc_nexus.nexus -T AUTO --prefix ./iqtree_concat_mafft/iqtree_concat_mafft -B 1000 -m MFP -alrt 1000
