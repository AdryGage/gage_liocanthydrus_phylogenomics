...
#SBATCH -t 24:00:00
#SBATCH -p single
#SBATCH -e ./error_out/_IQTREE-concat-gblock_%j.err
#SBATCH -o ./log_out/_IQTREE-concat-gblock_%j.log
...
iqtree -s ~/genome_skimming/concat/Concat_gblock_90perc_nexus/Concat_gblock_90perc_nexus.nexus -T AUTO --prefix ./iqtree_concat_gblock/iqtree_concat_gblock -B 1000 -m MFP -alrt 1000
