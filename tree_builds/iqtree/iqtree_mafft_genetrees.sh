#!/bin/bash
#SBATCH -J IQTREE-genetrees-mafft
#SBATCH -A allocation
#SBATCH -N 1
#SBATCH -n 64
#SBATCH -c 1
#SBATCH -t 24:00:00
#SBATCH -p single
#SBATCH -e ./error_out/_IQTREE-genetrees-mafft_%j.err
#SBATCH -o ./log_out/_IQTREE-genetrees-mafft_%j.log
...
iqtree -S ~/genome_skimming/aligned_completeness_matrix/Combined_mafft_90perc_nexus/ -T AUTO --prefix ./iqtree_genetrees_mafft/iqtree_genetrees_mafft -B 1000 -m MFP
