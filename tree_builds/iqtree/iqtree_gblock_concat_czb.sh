#!/bin/bash
#SBATCH -J IQTREE-concat-gblock-czb
#SBATCH -A allocation
#SBATCH -N 1
#SBATCH -n 64
#SBATCH -c 1
#SBATCH -t 24:00:00
#SBATCH -p single
#SBATCH -e ./error_out/_IQTREE-concat-gblock-czb_%j.err
#SBATCH -o ./log_out/_IQTREE-concat-gblock-czb_%j.log
...
iqtree -s ~/genome_skimming/concat/Concat_gblock_90perc_nexus/Concat_gblock_90perc_nexus.nexus -T AUTO --prefix ./iqtree_concat_gblock_czb/iqtree_concat_gblock_czb -B 1000 -m MFP -alrt 1000 -czb
