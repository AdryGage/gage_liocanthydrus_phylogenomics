#!/bin/bash
#SBATCH -J IQTREE-concat-gblock-part
#SBATCH -A allocation
#SBATCH -N 1
#SBATCH -n 64
#SBATCH -c 1
#SBATCH -t 24:00:00
#SBATCH -p single
#SBATCH -e ./error_out/_IQTREE-concat-gblock-part_%j.err
#SBATCH -o ./log_out/_IQTREE-concat-gblock-part_%j.log
...
iqtree -p ~/genome_skimming/aligned_completeness_matrix/Combined_gblock_90perc_nexus/ -T AUTO --prefix ./iqtree_concat_gblock_part/iqtree_concat_gblock_part -B 1000 -m MFP+MERGE -alrt 1000
